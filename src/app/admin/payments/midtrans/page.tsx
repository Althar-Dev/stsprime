    ...
    <div className="container mx-auto px-4 py-8 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          <h1 className="text-3xl font-black tracking-tight flex items-center gap-3">
            <Globe className="h-8 w-8 text-primary" /> Midtrans Gateway
          </h1>
          <p className="text-sm text-muted-foreground font-bold italic">Konfigurasi integrasi Midtrans untuk pembayaran Kartu Kredit, GoPay, QRIS, dan Bank Transfer.</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" className="rounded-xl font-black text-xs uppercase tracking-widest gap-2 h-10 border-border">
            <RefreshCw className="h-4 w-4" /> Cek Status API
          </Button>
          <a href="https://dashboard.midtrans.com" target="_blank" rel="noopener noreferrer">
            <Button className="rounded-xl font-black text-xs uppercase tracking-widest px-6 shadow-lg shadow-primary/20 gap-2 h-10">
              Merchant Portal <ExternalLink className="h-4 w-4" />
            </Button>
          </a>
        </div>
      </div>
          ...
          <Card key={i} className="bento-card border-border/50 bg-card/30 backdrop-blur-sm">
            <CardContent className="p-6 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline" className="text-[9px] font-black uppercase tracking-tighter opacity-60">Midtrans</Badge>
              </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <CardTitle className="text-lg font-black tracking-tight flex items-center gap-2">
                    <KeyRound className="h-5 w-5 text-primary" /> Pengaturan API Midtrans
                  </CardTitle>
                  <CardDescription className="text-xs font-bold">Dapatkan kredensial dari Dashboard Midtrans menu Settings &gt; Access Keys.</CardDescription>
                </div>
                <div className={cn(
            ...
            <CardContent className="p-6 space-y-6">
              <div className="grid sm:grid-cols-1 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input type="password" placeholder="Mid-server-..." className="h-11 bg-background rounded-xl font-bold border-border/50 pr-10" defaultValue="Mid-server-8821931211abcdef" />
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Mid-client-..." className="h-11 bg-background rounded-xl font-bold border-border/50" defaultValue="Mid-client-ok-1234567890" />
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-muted/20 border border-border/30 flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] text-muted-foreground font-bold">Aktifkan untuk mulai menerima pembayaran asli dari pelanggan.</p>
                </div>
          ...
          <Card className="bento-card border-border/50 bg-card/30 backdrop-blur-sm">
            <CardHeader className="border-b border-border/30 bg-muted/10">
              <CardTitle className="text-lg font-black tracking-tight">Kanal Pembayaran Midtrans</CardTitle>
              <CardDescription className="text-xs font-bold">Aktifkan atau nonaktifkan metode pembayaran yang tersedia di Snap Checkout.</CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6">
          <Card className="bento-card border-primary/20 bg-primary/5 h-full">
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-black uppercase tracking-widest">HTTP Notification Logs</CardTitle>
                ...
                {MOCK_MIDTRANS_LOGS.map((log) => (
                  <div key={log.id} className="p-4 hover:bg-muted/10 transition-colors space-y-2">
                    ...
                    <div className="flex justify-between items-end">
                      <div className="space-y-0.5">
                        <p className="text-xs font-bold">{log.channel || "Auto"}</p>
              ...
              <div className="p-4 pt-6 text-center space-y-4">
                ...
                <div className="space-y-2">
                   ...
                   <div className="flex gap-1">
                      <Input readOnly value="https://stsprime.com/api/midtrans/webhook" className="h-9 bg-background rounded-lg font-mono text-[10px] border-border/50" />
