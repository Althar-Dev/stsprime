    ...
    <div className="container mx-auto px-3 sm:px-6 md:px-8 py-3 sm:py-6 md:py-8 space-y-4 sm:space-y-6 md:space-y-8 animate-in fade-in duration-500 w-full max-w-full min-w-0">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        <div className="space-y-0.5 min-w-0">
          <h1 className="text-lg sm:text-2xl md:text-3xl font-black tracking-tight flex items-center gap-2 sm:gap-3 truncate">
            <Layers className="h-5 w-5 sm:h-7 sm:w-7 text-primary shrink-0" /> Manajemen Kategori
          </h1>
          <p className="text-xs sm:text-sm text-muted-foreground font-bold">Kelola pengelompokan layanan, ikon menu, dan struktur navigasi pengguna.</p>
        </div>
        ...
        <CardHeader className="p-4 sm:p-6 border-b border-border/30 bg-muted/10">
          <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4">
            <div className="space-y-0.5">
              <CardTitle className="text-base sm:text-lg font-black tracking-tight">Katalog Struktur Layanan</CardTitle>
              <CardDescription className="text-[10px] sm:text-xs font-bold">Atur hierarki dan prioritas tampilan kategori di halaman utama.</CardDescription>
            </div>
            ...
            <Table className="min-w-[750px] whitespace-nowrap">
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-border/30">
                  <TableHead className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest pl-4 sm:pl-6 h-10 sm:h-12">Ikon & Nama</TableHead>
                  <TableHead className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest h-10 sm:h-12">URL Slug</TableHead>
                  <TableHead className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest h-10 sm:h-12 text-center">Urutan</TableHead>
                  <TableHead className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest h-10 sm:h-12">Jumlah SKU</TableHead>
                    ...
                    <TableRow key={cat.id} className="hover:bg-muted/20 border-border/30 transition-colors group">
                      <TableCell className="py-3 sm:py-4 pl-4 sm:pl-6">
                        <div className="flex items-center gap-3">
                          <div className={cn("h-8 w-8 sm:h-10 sm:w-10 rounded-xl flex items-center justify-center border border-border/50 bg-background transition-transform group-hover:scale-110 shrink-0")}>
                            <cat.icon className={cn("h-4 w-4 sm:h-5 sm:w-5", cat.color)} />
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs sm:text-sm font-black tracking-tight truncate">{cat.name}</span>
                            <span className="text-[9px] sm:text-[10px] text-muted-foreground font-mono font-bold uppercase">{cat.id}</span>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell className="py-3 sm:py-4">
                        <code className="text-[9px] sm:text-[10px] font-bold bg-muted/50 px-2 py-0.5 rounded border border-border/50 text-muted-foreground">/{cat.slug}</code>
                      </TableCell>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 w-full">
        <Card className="bento-card border-primary/20 bg-primary/5 p-4 sm:p-6">
          <div className="flex gap-3 sm:gap-4">
            ...
            <div className="space-y-0.5 sm:space-y-1">
              <h3 className="font-black text-xs sm:text-sm uppercase tracking-wider">Navigasi Dinamis</h3>
        ...
        <Card className="bento-card border-border/50 bg-card/30 backdrop-blur-sm p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          <div className="space-y-0.5 sm:space-y-1">
            <h3 className="font-black text-xs sm:text-sm uppercase tracking-wider">Pemetaan Produk</h3>
            <p className="text-[11px] sm:text-xs text-muted-foreground font-bold italic">Terdapat 14 produk yang belum memiliki kategori induk.</p>
          </div>
