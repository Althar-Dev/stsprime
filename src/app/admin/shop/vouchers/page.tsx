    ...
    <div className="container mx-auto px-4 py-8 space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground font-bold italic">Kelola kode diskon, cashback koin, dan promo loyalitas pengguna.</p>
        </div>
      ...
      <Card className="bento-card border-border/50 bg-card/30 backdrop-blur-sm overflow-hidden">
        <CardHeader className="p-6 border-b border-border/30 bg-muted/10">
          <div className="flex flex-col md:flex-row justify-between gap-4">
            <div className="space-y-1">
              <CardTitle className="text-lg font-black tracking-tight">Katalog Promo</CardTitle>
              <CardDescription className="text-xs font-bold">Daftar seluruh voucher yang aktif dan riwayat promo.</CardDescription>
            </div>
            <div className="flex gap-2">
              <div className="relative w-full md:w-64">
                ...
                <input 
                  ...
                  className="pl-10 h-10 w-full bg-background border border-border text-xs font-bold rounded-xl outline-none focus:border-primary/50 transition-colors"
                  value={searchQuery}
            ...
            <Table className="min-w-[900px]">
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-border/30">
                  <TableHead className="text-[10px] font-black uppercase tracking-widest pl-6 h-12">Kode & Tipe</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest h-12">Potongan</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest h-12">Min. Belanja</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest h-12">Penggunaan</TableHead>
                  <TableHead className="text-[10px] font-black uppercase tracking-widest h-12">Masa Berlaku</TableHead>
                      ...
                      <TableCell className="py-4 pl-6">
                        <div className="flex items-center gap-3">
                          <div className="h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center border border-primary/20">
                            {voucher.type === "Percentage" ? <Percent className="h-5 w-5 text-primary" /> : <Zap className="h-5 w-5 text-primary" />}
                          </div>
                          <div className="flex flex-col">
                            <span className="text-xs font-black font-mono tracking-wider">{voucher.code}</span>
                            <span className="text-[10px] text-muted-foreground font-bold">{voucher.type === "Percentage" ? "Persentase" : "Potongan Tetap"}</span>
                          </div>
                        </div>
                      </TableCell>
