    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        <div className="mb-8 md:mb-12">
          <h1 className="font-headline text-3xl md:text-4xl font-black mb-3 uppercase tracking-tight">Personal Ledger</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-4 items-start">
          <div className="lg:col-span-1 space-y-4 md:space-y-6">
            <div className="bento-card p-5 md:p-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-1 gap-4">
                <div className="p-4 bg-muted/30 rounded-xl border border-border">
                  <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">Total Orders</p>
                  <p className="text-xl md:text-2xl font-black">24</p>
                </div>
                <div className="p-4 bg-muted/30 rounded-xl border border-border">
                  <p className="text-[10px] text-muted-foreground uppercase font-black tracking-widest">Total Spent</p>
            ...
            <div className="bento-card p-5 md:p-6 bg-primary/5 hidden sm:block">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-black uppercase text-xs md:text-sm">Mobile Legends</p>
          ...
          <div className="lg:col-span-3 space-y-6">
                ...
                <div key={order.id} className="bento-card p-4 md:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 md:gap-6 hover:translate-x-1 transition-transform border-border/50">
                  <div className="flex items-center gap-4 md:gap-5 w-full">
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        <h4 className="font-black text-sm md:text-lg uppercase truncate max-w-[150px] md:max-w-none">{order.item}</h4>
                      ...
                      <div className="flex flex-wrap items-center gap-y-1 gap-x-3 text-[10px] md:text-xs text-muted-foreground font-bold uppercase">
                  ...
                  <div className="flex items-center gap-4 md:gap-6 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 border-border/50 pt-4 sm:pt-0">
                    <div className="text-left sm:text-right">
                      <p className="text-[9px] md:text-[10px] text-muted-foreground font-black uppercase">Paid Amount</p>
            ...
            <div className="text-center py-6 md:py-8">
              <p className="text-[10px] md:text-sm text-muted-foreground font-bold uppercase tracking-widest">Showing 4 of 24 transactions</p>
              <Button variant="link" className="mt-2 text-primary font-black uppercase text-xs">Load more history</Button>
            </div>
          </div>
        </div>
      </main>
