            ...
            {populerItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="group bento-card p-1.5 bg-grid-pattern transition-all active:scale-95 flex flex-row aspect-[16/7] overflow-hidden items-center hover:scale-[1.03] hover:shadow-lg"
                >
