  ...
  return (
    <section className="container mx-auto px-4 py-8 md:py-12">
      <div className="mb-6 md:mb-8 flex items-end justify-between">
        <div>
          <h2 className="font-headline text-2xl md:text-3xl lg:text-4xl font-black uppercase tracking-tight">Available Services</h2>
          ...
          return (
            ...
            >
              <div className="relative h-full w-full overflow-hidden">
                ...
                {item.tag && (
                  <Badge className="absolute left-2 top-2 bg-primary/90 text-primary-foreground text-[9px] md:text-[10px] font-black uppercase tracking-tighter border-none px-2 py-0.5">
                    {item.tag}
                  </Badge>
                )}

                <div className="absolute bottom-0 left-0 w-full p-3 md:p-4">
                  <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-accent font-black">
                    {item.type}
                  </p>
                  <h3 className="line-clamp-1 text-xs md:text-sm lg:text-base font-black uppercase">
                    {item.name}
                  </h3>
                </div>
