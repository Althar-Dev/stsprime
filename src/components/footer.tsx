    ...
    <footer className="mt-12 md:mt-20 border-t border-border bg-card/20 py-10 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid gap-10 md:gap-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h4 className="font-black uppercase text-xs md:text-sm text-foreground tracking-widest mb-4">Services</h4>
            <ul className="space-y-3 text-xs md:text-sm text-muted-foreground font-bold uppercase">
          ...
          <div>
            <h4 className="font-black uppercase text-xs md:text-sm text-foreground tracking-widest mb-4">Support</h4>
            <ul className="space-y-3 text-xs md:text-sm text-muted-foreground font-bold uppercase">
          ...
          <div>
            <h4 className="font-black uppercase text-xs md:text-sm text-foreground tracking-widest mb-4">Newsletter</h4>
            <p className="text-[10px] md:text-xs text-muted-foreground font-bold uppercase mb-4">Get updates on new discounts and hot releases.</p>
            <div className="flex flex-col gap-2">
              ...
              <button className="h-10 w-full rounded-lg bg-primary px-4 text-xs font-black uppercase text-primary-foreground hover:bg-primary/90 transition-colors">Join Hub</button>
            </div>
          </div>
        </div>
        <div className="mt-12 md:mt-16 border-t border-border pt-8 text-center">
          <p className="text-[9px] md:text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em]">
